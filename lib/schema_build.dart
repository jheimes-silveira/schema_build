/// Schema Build — A Flutter UI Builder library with Drag and Drop support.
///
/// Provides a visual editor for creating mobile app layouts via drag and drop.
/// The editor generates a JSON schema that represents the configured layout.
library;

export 'src/models/schema_config.dart';
